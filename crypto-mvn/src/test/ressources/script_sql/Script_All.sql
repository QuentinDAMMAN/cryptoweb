CREATE USER 'cryptoTest'@'localhost' IDENTIFIED BY 'cryptopwdTest';
CREATE DATABASE crypto_bdd_test;
GRANT ALL PRIVILEGES ON crypto_bdd_test.* TO 'cryptoTest'@'localhost';
FLUSH PRIVILEGES;
