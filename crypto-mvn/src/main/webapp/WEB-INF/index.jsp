			...
			<div class="flex-column flex-md-row ">
				...
				<div class="dropdown position-drop">
					<button class="btn btn-secondary dropdown-toggle mt-1"
						type="button" data-toggle="dropdown">Actions Cryptos</button>
					<div class="dropdown-menu fondGris">
						<a class="dropdown-item fondGris" id="ajouterModal" href="#">Ajouter</a>
						<a class="dropdown-item fondGris" id="modifierModal" href="#">Modifier
							prix</a> <a class="dropdown-item fondGris" id="supprimerModal"
							href="#">Supprimer</a>
					</div>
				</div>
			</div>
			...
			<div class="modal-content couleur-label">
				...
				<div class="modal-body ">
					<form action="/crypto-mvn/ajout" method="post">
						<label for="nom" style="margin-left: 37px">Nom : </label> <input
							id="nomA" type="text" name="nom"> <br> <label
							for="label" style="margin-left: 35px">Label : </label> <input
							id="textA" type="text" name="label"> <br> <label
							for="prix">Prix actuel : </label> <input type="number"
							step="0.01" name="prix"> <br>
						<hr>
						<button id="submitModalAdd" type="submit"
							class="btn btn-primary bgd">Ajouter</button>
						<button id="closeModalAdd" type="button"
							class="btn btn-secondary droite" data-dismiss="modal">Annuler</button>
					</form>
				</div>
			</div>
		</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="/crypto-mvn/prix" method="post">
						<br> <label for="label" style="margin-left: 57px">Label
							: </label> <input type="text" name="label"> <br> <label
							for="prix">Nouveau prix : </label> <input type="number"
							step="0.01" name="prix"> <br>
						<hr>
						<button id="submitModalUpd" type="submit"
							class="btn btn-primary bgd">Modifier</button>
						<button id="closeModalUpd" type="button"
				...
				<div class="modal-body">
					<form action="/crypto-mvn/supp" method="post">
						...
						<button id="submitModalDel" type="submit"
							class="btn btn-primary bgd">Supprimer</button>
					...
					<div id="acheter${vs.index}" class="modal" tabindex="-1"
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content" style="width: 375px;">
								<div class="modal-header">
									<h5 class="modal-title" style="margin-left: 33%">ACHAT
										${cryptomonnaies.label }</h5>
								...
								<div class="modal-body pt-0">
									<form method="post" action="/crypto-mvn/achat">
										<p class="text-center">Prix actuel :
											${cryptomonnaies.prixActuel }</p>
